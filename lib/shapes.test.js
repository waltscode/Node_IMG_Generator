...
// GRABBING the variables from the shapes.js doc 
const { Circle, Triangle, Square } = require('./shapes')
// GRABBING the code from index.js
...
test('Circle renders SVG correctly', () => {
    ...
    // Normalize whitespace in the expected value - THE (/\s/g, '') IS USED TO REMOVE ANY VARIABLES IN THE CHUNK OF CODE THAT HAS SPACES, INDENTS OR OTHER FORMATTING CAUSING THE TEST TO FAIL 
